	...
	<section class="hero-section set-bg" data-setbg="img/bg.jpg">
		<div class="hero-slider owl-carousel">
			<div class="hs-item">
				...
				<div class="hs-right">
					<div class="hs-content">
						...
						<h2><span>2020</span> <br>S-tore Goods</h2>
			...
			<div class="hs-item">
				...
				<div class="hs-right">
					<div class="hs-content">
						<h2><span>Buy, Sell, and Find</span> <br>Everything Here</h2>
					</div>	
				</div>
			</div>
		</div>
			...
			<ul class="slidee">
				<li>
					<div class="intro-item">
						<figure>
							<img src="img/intro/ducati.jpg" alt="#">
						</figure>
						<div class="product-info">
							<h5>Ducati Monster</h5>
							<p>$319.50</p>
							<a href="detail.html" class="site-btn btn-line">DETAIL</a>
						</div>
					</div>
				</li>
				<li>
					<div class="intro-item">
						<figure>
							<img src="img/intro/ferrari.jpg" alt="#">
						</figure>
						<div class="product-info">
							<h5>Ferrari</h5>
							<p>$319.50</p>
				...
				<li>
					<div class="intro-item">
						<figure>
							<img src="img/intro/rumah.jpeg" alt="#">
							<div class="bache">NEW</div>
						</figure>
						<div class="product-info">
							<h5>Rumah Mewah Pulomas</h5>
							<p>$319.50</p>
							<a href="#" class="site-btn btn-line">DETAIL</a>
						</div>
					</div>
